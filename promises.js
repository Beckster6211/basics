...
if was a dishwasher, pending-dishwasher running but not complete, fulfilled-dishwasher complete washed and full of clean dishes, rejected-dishwasher encountered problem (didn't recieve soap) returns unclean dish 

///// constructing a promise object 
create new Promise object use new keyword and Promise constructor 
*/
...
const myFirstPromise = new Promise(executorFunction);
declare variable myFirstPromise
myFirstPromise constructed new Promise()
executorFunction() passed to constructor, two parameters resolve and reject 
if someCondition evaluates to true invoke resolve(string "I resolved!")
if not invoke reject(string "I reject!")
*/

/*
// example, a database request may fulfill with the data from a query or reject with an error thrown.
